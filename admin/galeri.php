                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $p['keterangan'] ?></td>
                                <td>
                                    <a href="edit-galeri.php?id=<?= $p['id'] ?>" title="Edit Galeri" class="text-orange"><i class="fa fa-edit"></i></a> |
                                    <a href="hapus.php?idgaleri=<?= $p['id'] ?>" onclick="return confirm('Yakin Ingin Menghapus ?')" title="Hapus Data" class="text-red"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php }}else{ ?>
                                <tr>
